...
const Footer: React.FC = () => {
	return (
		<footer
			className='footer mt-auto border-top'
				...
				<div className='row g-4'>
					...
					<div className='col-12 col-md-6 col-lg-3'>
						...
						<ul className='list-unstyled mb-0'>
							...
							<li className='mb-2'>
								<Link
									to='/sjednat-pojisteni?src=footer'
									className='text-muted-ink text-decoration-none small'
								>
									Sjednat pojištění
								</Link>
					...
					<div className='col-12 col-md-6 col-lg-3'>
						...
						<p className='text-muted-ink small mb-0'>
							Tento web je pouze informativní a neposkytuje žádnou formu
							poradenství. Informace jsou poskytovány bez záruky. Web využívá
							partnerské (affiliate) odkazy pro podporu provozu.
						</p>
					</div>
				</div>

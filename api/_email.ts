 ...
 * client — use the canonical www host directly so the image isn't loaded
 * through the apex→www 308 (some clients won't follow it). The PNG is
 * generated by `scripts/generate-email-logo.ts`.
 */
export const EMAIL_LOGO_URL = 'https://www.vininfo.cz/logo-email.png'
				...
				<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" style="max-width: 600px; width: 100%;">
					...
					<tr>
						<td class="email-footer email-border email-text-muted" style="background-color: #f8f9fa; padding: 20px; border: 1px solid #e9ecef; border-top: none; border-radius: 0 0 8px 8px; text-align: center; font-size: 12px; color: #888;">
							<p style="margin: 0;">Tento email byl odeslán ze služby <a href="https://www.vininfo.cz" style="color: #555; text-decoration: none;">VINInfo.cz</a></p>
						</td>
					</tr>
				</table>
			</td>
							...
							<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="margin: 24px 0 0;">
								<tr>
									<td style="border-top: 1px solid #e9ecef; padding-top: 16px;">
										...
										<a href="https://www.vininfo.cz/registrace" style="display: inline-block; background-color: #eaf4eb; color: #2e7d32; text-decoration: none; padding: 10px 20px; border-radius: 8px; font-weight: 600; font-size: 14px;">Vytvořit Moje VINInfo</a>
									</td>
								</tr>
							</table>
							<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="margin: 24px 0 0;">
